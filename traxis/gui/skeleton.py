...
#########################################################################
        self.saveOverSessionButton = QtWidgets.QPushButton(self)
        self.saveLayout.addWidget(self.saveOverSessionButton)
        # don't focus on this widget when clicked
        self.saveOverSessionButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.saveOverSessionButton.setText("saveOverSessionButton")
        self.saveOverSessionButton.setToolTip("Test123")
